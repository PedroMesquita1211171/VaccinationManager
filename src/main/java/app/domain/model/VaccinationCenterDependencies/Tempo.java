...
public class Tempo implements Comparable<Tempo>, Serializable {
    ...
    /**
     * Verifica se os segundos são válidos.
     * @param segundos
     */
     ...
     * @param horas
     */
    private void checkHoras(int horas) {
        if (horas < 0 || horas > 23) {
     ...
     * @return true se o tempo for maior do que o tempo recebido por parâmetro,         caso contrário devolve false.
     */
     ...
     * @return true se o tempo for maior do que o tempo (horas, minutos e         segundos) recebido por parâmetro, caso contrário devolve false.
     */
     ...
     * parâmetro.
     *
     * @param outroTempo o outro tempo com o qual se compara o tempo para                   calcular a diferença em segundos.
     * @return diferença em segundos entre o tempo e o tempo recebido por         parâmetro.
     */
     ...
     *
     * @param outroTempo o outro tempo com o qual se compara o tempo para obter                   uma instãncia Tempo representativa da diferença entre                    o tempo e o tempo recebido por parâmetro.
     * @return instância Tempo representativa da diferença entre o tempo e o         tempo recebido por parâmetro.
     */
    ...
    /**
     * Devolve o tempo em String format.
     *
     *
     * @return toString
     */
